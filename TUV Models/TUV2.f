...
! Agregado por Giovanni Gamaliel L�pez Padilla
      ...
      integer totalarc,arc,i,j,k,n,m,ciclo,station,carp
      integer nstation
      real,dimension(2):: aod
      real uva,eri,op,hour
      real,dimension(1440):: mod
...
c      intrct = .FALSE.}
     ...
     $     ims,    slabel, imj,    jlabel)
      ...
      read(202,*) outfil,iyear,imonth,iday,aod(1),aod(2)
      !Variables de control
      if(o3_tc.ne.0) then
      if (carp.eq.1) then
      open(104,file="../2016/Resultados/"//outfil//"Erymo.txt")
      open(103,file="../2016/Resultados/"//outfil//"UVAmo.txt")
      else
      open(104,file="../2017-2018/"//namestation//"/Resultados/"
     &//outfil//"Erymo.txt")
      open(103,file="../2017-2018/"//namestation//"/Resultados/"
     &//outfil//"UVAmo.txt")
      end if 
      write(*,*) "Calculando el dia ",outfil," de la estacion "
     &,namestation
      !Ciclo que varia el aod
      do k=1,2
      tauaer=aod(k)
