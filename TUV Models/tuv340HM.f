...
! Agregado por Giovanni Gamaliel L�pez Padilla
       integer ciclohora,archivo,narc,rep,repe,nsta,sta
...
!Se llama al archivo que contiene todos los par�metros de cada d�a
        open(13,file="../"//stafile//"/"//type//"/datoswhora.txt")
        read(13,*) narc
       do  archivo=1,narc
       read(13,*) rep
       do repe=1,rep
       read(13,*) outfil,tauaer,o3_tc,iyear,imonth,iday,tstart,tstop
       if(o3_tc.ne.0) then
...
* ____ SECTION 9: OUTPUT ______________________________________________
 ...
 30   continue
 !Cierre del do para la irradincia para cada minuto para la hora en la que
 !existe dato de AOD
      end if
      end do
