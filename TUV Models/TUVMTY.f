...
c      intrct = .FALSE.}
     ...
     $     ims,    slabel, imj,    jlabel)
      ...
      open(100,file="../Stations/noreste/datos.txt")
      open(202,file="../Stations/noreste/aod.txt")
      read(100,*) totalarc
      !Ciclo que sirve para ir variando los dias
      do arc=1,totalarc
      read(100,*) outfil,iday,imonth,iyear,o3_tc
      ...
      aod=0
      mod=0
      open(103,file="../Stations/noreste/Mediciones/"//outfil//".txt")
      do i=1,11
      read(103,*) hora,med
      end do
      medm=0
...
* ____ SECTION 9: OUTPUT ______________________________________________
 ...
 30   continue
      ...
      open(103,file="../ResultadosTUV/"//outfil//".txt")
      !Ciclo de la hora
      do k=1,3
      !Letras dummuy
      do i=1,5
      ...
      close(103)
      !Calculo del promedio maximo
      maxmod=0
      do i=1,180
      if (maxmod.lt.modm(i)) then
      maxmod=modm(i)
      tmax=i
      end if
      end do
      n=0
      maxmod=0
      do i=tmax-30,tmax+31
      maxmod=maxmod+modm(i)
      n=n+1
      end do
      maxmod=maxmod/n
