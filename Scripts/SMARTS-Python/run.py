    ...
    for i in range(n):
        ...
        while var==False:
            ...
            for min in range(180):
                ...
                os.system("cd Code && ./smarts.out && cd ..")
                resul[min]=np.sum(np.loadtxt("Code/data.ext.txt",skiprows=121)[:,1])
                os.system("rm Code/data.inp.txt")
