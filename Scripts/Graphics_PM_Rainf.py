...
station = "NORESTE"
PM_10 = SIMA_data(inputs["year initial"], inputs["year final"], inputs["stations"])
RAINF = SIMA_data(inputs["year initial"], inputs["year final"], inputs["stations"])
...
PM_10.plot_month_means_Rain(
    [RAINF.month_mean,"Rainfall"])
