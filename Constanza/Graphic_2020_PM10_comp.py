...
PM10_2015_2019_month_std = PM10_2015_2019.groupby(PM10_2015_2019.index.month).std()
PM10_2020_month_mean = PM10_2020.groupby(PM10_2020.index.month).mean()
PM10_2020_month_std = PM10_2020.groupby(PM10_2020.index.month).std()
...
for station in stations:
    ...
    plt.fill_between(np.arange(1, 13),PM10_2015_2019_month_mean[station]-PM10_2015_2019_month_std[station],
             PM10_2015_2019_month_mean[station]+PM10_2015_2019_month_std[station],alpha=.2,color="blue")
    plt.plot(np.arange(1, 13), list(PM10_2020_month_mean[station]),
            ls="--", color="orangered", lw=2.5, marker="o", label="2020")
    plt.fill_between(np.arange(1, 13),PM10_2020_month_mean[station]-PM10_2020_month_std[station],
             PM10_2020_month_mean[station]+PM10_2020_month_std[station],alpha=.2,color="orangered")
